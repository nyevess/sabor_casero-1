<?php
//analizamos con if si el usuario a pulsado el boton de añadir el producto al pedido y guardamos en variables los datos del plato seleccionado
if (isset($_POST["agregar"])) {
    ...
    if (!isset($_SESSION['carrito'])) {
        //si no existe la sesion carrito la creará y guardará la informacion del plato
        $lineaPedido=array(
          'id_plato'=>$id_plato,
          'plato'=>$plato,
          'pvp'=>$pvp,
        ...
        //y la guardará en la posicion 0
        $_SESSION['carrito'][0]=$lineaPedido;
    } else {
        //usamos el ese para si ya existe un producto en el carrito contamos lo que hay en la sesion carrito y lo almacenamos en $numeroproductos, volvemos a recolectar la informacion y lo volvemos a almacenar en la sesion,
...
<?php
    ...
    echo "<h3>Añade tus productos al pedido</h3>";
}
