  ...
  <div class="container__pagina">
      ...
      <section class="main__entrar__general">
        ...
        <nav class="main__nav">
          <a href="cambiar_datos_cliente_dependiente.php">
            <h4 class="insertar__pedido">VER/CAMBIAR DATOS CLIENTE</h4>
          </a>
          <a href="insertar_pedido_dependiente.php">
            <h4 class="insertar__pedido">NUEVO PEDIDO</h4>
          </a>
          ...
          <a href="insertar_nuevo_cliente_dependiente.php">
            <h4 class="insertar__pedido">NUEVO CLIENTE</h4>
          </a>
        </nav>
        ...
        <section class="main__formulario">
          ...
          <h4 class="insertar__titulo">Insertar nuevo cliente: </h4>
          ...
          <?php
          include("script/insertar_cliente.php");
          ?>
        </section>
      </section>
    </main>
    <footer class="footer">
      ...
      <ul class="footer__logo">
        <li>
          <img class="footer__logo_img" src="../assets/img/svg/logo.svg" alt="" />
        </li>
        <li>
      ...
      <ul class="footer__redes">
        ...
        <li>
          <a href="facebook/saborcasero"><img class="logo__face" src="../assets/img//svg/logo_facebook.svg" alt="" /></a><a href="instagram/saborcasero"><img class="logo__insta" src="../assets/img//svg/logo_insta.svg" alt="" /></a><a href="twitter/saborcasero"><img class="logo__twi" src="../assets/img//svg/logo_twitter.svg" alt="" /></a>
        </li>
      </ul>
    </footer>
  </div>
