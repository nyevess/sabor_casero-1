    ...
    <main class="main">
      <section class="main__entrar__general">
        ...
        <nav class="main__nav"> <a href="cambiar_datos_cliente_gerente.php">
          ...
          </a><a href="insertar_pedido_gerente.php">
            <h4 class="insertar__pedido">NUEVO PEDIDO</h4>
          </a><a href="ver_pedidos_hoy_gerente.php">
            <h4 class="insertar__pedido">PEDIDOS DE HOY</h4>
          </a><a href="insertar_nuevo_cliente_gerente.php">
            <h4 class="insertar__pedido">NUEVO CLIENTE</h4>
          </a><a href="insertar_platos.php">
            <h4 class="insertar__pedido">INSERTAR PLATOS</h4>
          </a><a href="insertar_trabajador.php">
            <h4 class="insertar__pedido">NUEVO TRABAJADOR</h4>
          </a></nav>
