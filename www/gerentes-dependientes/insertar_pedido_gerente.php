...
include("script/sesion_geren.php");
        ...
        ?></h2>
          ...
          <nav class="main__insertar__nav"> <a href="cambiar_datos_cliente_gerente.php">
        ...
        <section class="main__ver__pedido">
            <form class="ver__pedido" action="<?php echo $_SERVER['PHP_SELF']; ?>" method="post">
              ...
              <input type="date" class="input"  min="<?php echo date("Y-m-d",strtotime(date("Y-m-d")));?>"  name="fecha"><br>
